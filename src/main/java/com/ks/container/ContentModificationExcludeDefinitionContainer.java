...
import com.ks.pojo.ContentModificationExcludeDefinition;
...
public final class ContentModificationExcludeDefinitionContainer extends SimpleDefinitionContainer {
	...
	private static final String KEY_EXCLUDE_INCOMING_LINKS_FROM_MODIFICATION = "excludeIncomingLinksFromModification"; // = links in responses of other pages pointing to this matching URI won't get modified
	...
	protected void doParseSimpleDefinitionDetailsAndRemoveKeys(final SimpleDefinition definition, final Properties properties) throws PatternSyntaxException, IllegalRuleDefinitionFormatException {
		...
		// load custom properties
		{
			...
			if (value == null)
				throw new IllegalRuleDefinitionFormatException("Missing content-modification-exclude specific value: " + KEY_EXCLUDE_OUTGOING_RESPONSES_FROM_MODIFICATION + " for rule: " + contentModificationExcludeDefinition.getIdentification());
		...
		}
		{
			...
			if (value == null)
				throw new IllegalRuleDefinitionFormatException("Missing content-modification-exclude specific value: " + KEY_EXCLUDE_INCOMING_LINKS_FROM_MODIFICATION + " for rule: " + contentModificationExcludeDefinition.getIdentification());
		...
		}
		{
			...
			if (value == null)
				throw new IllegalRuleDefinitionFormatException("Missing content-modification-exclude specific value: " + KEY_EXCLUDE_INCOMING_LINKS_FROM_MODIFICATION_EVEN_WHEN_FULL_PATH_REMOVAL_ENABLED + " for rule: " + contentModificationExcludeDefinition.getIdentification());
