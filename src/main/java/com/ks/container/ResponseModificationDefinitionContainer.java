 ...
 import com.ks.pojo.ResponseModificationDefinition;
			...
			}
			{
				...
				try {
                    ...
                    for (String token : tokens) {
                        ...
                        if (groupNumber > responseModificationDefinition.getUrlCapturingPattern().matcher("TEST").groupCount())
                            throw new IllegalRuleDefinitionFormatException("Configured pattern has no corresponding capturing group for response-modification specific value: " + KEY_CAPTURING_GROUP_NUMBERS + " for rule: " + responseModificationDefinition.getIdentification() + ": " + value);
